        ...
        public CameraView()
        {
            ...
            GStreamer.onNewImage += (sender, image) =>
            {
                try
                {
                    ...
                    //                string name = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "//screenshot-" + _fileCount + ".png";
            ...
            _videoSaveSegmentTimer.Interval = _segmentLength*500;
